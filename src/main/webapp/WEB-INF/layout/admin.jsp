		...
		<div class="col-md-10 offset-1">
			<div class="m-section">
				<div class="m-section__content">
				   ...
				   <h3 class="te-center h-font">Danh sách đăng kí</h3>
		...
		<ul class="pagination offset-4">
			<c:if test="${page>1}">
				<li class="page-item"><a class="page-link"
					href="admin-page?page=${page-1}">Previous</a></li>
			</c:if>
			...
			<c:if test="${page<numPage}">
				<li class="page-item"><a class="page-link"
					href="admin-page?page=${page+1}">Next</a></li>
			</c:if>
			<c:if test="${page==numPage}">
